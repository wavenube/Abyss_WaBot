 ...
 *  - This function has been deprecated in favor of `useMultiFileAuthState`
 *  - This function will be removed in the next major version
 *  - You can use `useMultiFileAuthState` instead
 *  - deprecated by being so slow. has memory issues/leakages 
...
function loadMessage(jid, id = null) {
  // TODO: Implement a better way to load messages
  // TODO: Implement a way to load messages by JID
  // TODO: Implement Map to store messages
  let message = null;
  if (jid && !id) {
    id = jid;
